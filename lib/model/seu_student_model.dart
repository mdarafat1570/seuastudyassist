...
//   Null? transferredStudent;
//   Null? oldStudentId;
//   Null? newStudentId;
//   Null? cancelledStudent;
//   Null? cancelledTime;
//   int? runningSemester;
...
//   Null? totalWaivedCredits;
//   int? totalDue;
//   int? minimumDue;
//   Null? adviserInitial;
//   Null? adviserUsername;
//   Null? adviserName;
//   Null? adviserDesignation;
...
//   SeuStudentModel.fromJson(Map<String, dynamic> json) {
//     id = json['id'];
//     ugcId = json['ugcId'];
...
//       });
//     }
//     lateFineAmount = json['lateFineAmount'] != null
//         ? new LateFineAmount.fromJson(json['lateFineAmount'])
//         : null;
//   }
...
//     }
//     if (this.lateFineAmount != null) {
//       data['lateFineAmount'] = this.lateFineAmount!.toJson();
//     }
//     return data;
//   }
// }
...
//   int? sectionLimit;
//   Null? programWiseSectionLimitList;
//   Null? registeredStudentList;
//   Null? wishedStudentList;
//   Null? coursePrototype;
//   Null? classroomCode;
//   Null? exam;
//   Null? sectionWiseExamMarksList;
//   Null? sectionWiseExamSpecialGradeList;
//   Null? marksSubmitApplicationId;
//   Null? gradeSubmitApplicationId;
//   Null? applicationFinalDecision;
//   Null? note;
//   Null? midExamDate;
//   Null? finalExamDate;
//   Null? gradeReceiptInformation;
//   Null? scriptGivenInMid;
//   Null? scriptGivenInFinal;
//   Null? examRoomInMid;
//   Null? invigilatorUsernameInMid;
//   Null? invigilatorNameInMid;
//   Null? looseSheetGivenInMid;
//   Null? looseSheetGivenInFinal;
//   Null? examRoomInFinal;
//   Null? invigilatorUsernameInFinal;
//   Null? invigilatorNameInFinal;
//   Null? appearedStudentCountInFinal;
//   Null? usedScriptCountInMid;
//   Null? usedScriptCountInFinal;
//   Null? reportedScriptCountInFinal;
...
//   Name({this.firstName, this.fullName});
...
//         subTopicList!.add(new Null.fromJson(v));
//       });
//     }
//   }
...
//   LateFineAmount(
//       {this.amount, this.days, this.message, this.messageTransaction});

//   LateFineAmount.fromJson(Map<String, dynamic> json) {
//     amount = json['amount'];
//     days = json['days'];
...
//     data['messageTransaction'] = this.messageTransaction;
//     return data;
//   }
// }